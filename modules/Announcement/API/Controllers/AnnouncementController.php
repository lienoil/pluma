...
class AnnouncementController extends APIController
{
    ...
    public function search(Request $request)
    {
        ...
        $resources = Announcement::search($search)->orderBy($sort, $order);
        if ($onlyTrashed) {
    ...
    public function getTrash(Request $request)
    {
        ...
        $permissions = Announcement::search($search)->orderBy($sort, $order)->onlyTrashed()->paginate($take);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if (in_array($announcement->code, config('auth.rootannouncements', []))) {
            $this->errorResponse['text'] = "Deleting Root Announcements is not permitted";

            return response()->json($this->errorResponse);
        }

        $this->successResponse['text'] = "{$announcement->name} moved to trash.";
        $announcement->delete();
