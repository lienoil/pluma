    ...
    >
        ...
        <template slot="media" scope="props">
            <v-card transition="scale-transition" class="accent" :class="props.item.active?'elevation-10':'elevation-1'">
                ...
                <v-card-title primary-title class="body-1 white--text" v-html="props.item.originalname"></v-card-title>
                <v-card-actions class="px-2 white--text">
                    <v-icon class="title white--text" v-html="props.item.icon"></v-icon>
                    <span v-html="props.item.mimetype"></span>
                    <v-spacer></v-spacer>
                    <span class="caption" v-html="props.item.mime"></span>
                    <span class="caption" v-html="props.item.filesize"></span>
                </v-card-actions>
            </v-card>
        </template>
    </v-mediabox>
