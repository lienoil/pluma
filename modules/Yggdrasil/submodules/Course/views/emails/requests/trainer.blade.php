                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 40px 0 30px 0; font-family: Open Sans, sans-serif;">
                                        <img src="brand.png" alt="SSA Academy" width="80" style="display: block;" />
                                        <h1 style="font-weight: 400; color: #424242; font-size: 23px; font-family: Open Sans, sans-serif;">New Course Request</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="padding: 40px 0 30px 0; border-radius: 3px;">
                                        <img src="image-table.png" alt="SSA Academy" width="300" style="display: block;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 50px 0; font-family: Montserrat, sans-serif; margin: 0; color: #636262; font-size: 14px; font-weight: 500;">
                                        ...
                                        <h2>Hi, John Appleseed!</h2>
                                        <p style="font-size: 17px;">
                                            There is a pending request from a student for the following course:</p>
                                    </td>
                                </tr>
                                <tr>
