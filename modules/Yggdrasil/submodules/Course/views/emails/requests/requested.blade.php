...
<head>
    ...
    <title>{{ __('Your Course Request is Being Reviewed') }}</title>
    <style type="text/css">
                    ...
                    <tr>
                        <td class="innerpadding borderbottom" bgcolor="#ffffff" style="border-radius: 3px;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="100%">
                                        <h1 style="font-weight: 400; color: #424242; font-size: 23px; font-family: Open Sans, sans-serif;">Course Request</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="padding: 40px 0 30px 0; border-radius: 3px;">
                                        <img src="{{ $message->embed(assets('course/images/image-table.png')) }}" width="300" style="display: block;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 50px 0; font-family: Montserrat, sans-serif; margin: 0; color: #636262; font-size: 14px; font-weight: 500;">
                                        ...
                                        <p style="font-size: 17px;">
                                            {{ __('Your request to enroll to a course is being reviewed. Please wait at least 2-3 days upon submission request.') }}</p>
                                    </td>
                                </tr>
                                <tr>
