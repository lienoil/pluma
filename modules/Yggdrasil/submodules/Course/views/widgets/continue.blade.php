<v-card
    ...
    <div class="insert-overlay" style="background: rgba(0, 0, 0, 0.38); position: absolute; width: 100%; height: 100%; z-index: 0;">
    </div>
    <v-layout row wrap>
        <v-flex sm8>
            <v-card-text>
                ...
                <v-layout row wrap class="media">
                    ...
                    <v-btn outline class="white white--text mt-3 m-0">
                        Continue
                    </v-btn>
            </v-card-text>
        </v-flex>
