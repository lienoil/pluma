            ...
            <v-app class="application--light">
                        ...
                        <v-layout column class="media">
                            ...
                            <v-card-text class="white--text text-xs-center mb-5">
                                ...
                                <div class="subheading mb-5">
                                    <v-flex md6 offset-md3>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</v-flex>
                                </div>
                            </v-card-text>
                        </v-layout>
                    </v-layout>
                ...
                <v-container fluid grid-list-lg>
                    <v-layout row wrap>
                        <v-flex md3 order-lg1 order-md1 order-sm3 order-xs3 xs12>
                            <v-card class="elevation-1 card--flex-toolbar">
                                ...
                                {{-- <v-card-text class="text-xs-center" height="200px">
                                        <img src="{{ assets('frontier/images/placeholder/empty_assignmnet.jpg') }}" height="170px" alt="">
                                ...
                                <v-card-text>
                                    <div class="subheading mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos provident libero ea repellendus maxime totam aspernatur commodi qui velnihil. Autem id harum itaque fugit mollitia saepe earum quis voluptatibus.</div>
                                ...
                                <v-list two-line subheader>
                                    ...
                                    <v-list-tile ripple @click="">
                                        ...
                                        <v-list-title-content>
                                            <v-list-title-title>Georgina Scott</v-list-title-title>
                        ...
                        <v-flex md6 order-lg2 order-md2 order-sml order-xs1 xs12>
                            <v-card class="elevation-1 card--flex-toolbar">
                                ...
                                <v-card-text class="pb-0">
                                    <v-card class="elevation-1">
                                        <v-list two-line subheader class="pb-0">
                                            <v-list-tile avatar ripplec @click="">
                                                <v-list-tile-avatar>
                                                ...
                                                {{-- <v-list-tile-action>
                                                    <v-icon
                                                    class="grey--text text--lighten-1">chevron_right</v-icon>
                                                </v-list-tile-action> --}}
                                            </v-list-tile>
                                        </v-list>
                                    </v-card>
