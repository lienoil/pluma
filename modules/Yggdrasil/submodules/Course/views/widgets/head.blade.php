<v-parallax clas="elevation-1" src="{{ assets('frontier/images/placeholder/gradient.png') }}" height="300">
                                ...
                                <v-flex md9 sm10>
                                    <div>
                                        ...
                                        <v-footer class="transparent">
                                            <v-chip label small class="pl-0 ml-0 caption transparent grey--text elavation-0">
                                                <v-icon left small class="subheading">fa-tasks</v-icon>&nbsp;<span v-html="`3 Parts`"></span>
                                            </v-chip>
