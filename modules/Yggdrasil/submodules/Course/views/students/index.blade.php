                    ...
                    <v-card class="elevation-1 mb-3">
                        ...
                        <template v-if="resource.users.length">
                            ...
                            <v-card-text>
                                ...
                                ></v-select>
                                <input type="hiddent" name="users[]" :value="id" v-for="(id, i) in suppliments.users.selected" :key="i">
            ...
            <v-flex md9 xs12>
                <v-card class="mb-3 elevation-1">
                    <v-toolbar flat clas="transparent">
                        ...
                        {{-- Batch Commands --}}
                        <v-btn
                            v-show="dataset.seleted.length < 2"
                            flat
                            icon
                                        ...
                                        <v-card-actions class="pa-3">
                                            ...
                                            <form
                                                ...
                                                <v-btn @click="$refs[`drop_${prop.item.id}`].submit()"
                                                    class="elavation-0 ma-0 error white--text">{{ __('Yes') }}
                                                </v-btn>
                                            </form>
                                        </v-card-actions>
                                    </v-card>
