...
{
    /**
     * Listen to the CourseObserver created event.
     *
    ...
    /**
     * Listen to the CourseObserver updated event.
     *
     * @param  \Course\Models\Course  $resource
     * @return void
     */
    ...
    /**
     * Listen to the CourseObserver deleted event.
     *
     * @param  \Course\Models\Course  $resource
     * @return void
     */
    ...
    /**
     * Listen to the CourseObserver restored event.
     *
     * @param  \Course\Models\Course  $resource
     * @return void
     */
