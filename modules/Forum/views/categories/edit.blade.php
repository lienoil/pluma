    ...
    <v-container fluid grid-list-lg>
        <v-layout row wrap justify-center align-center>
            <v-flex xs8>
                ...
                <form action="{{ route('forums.categories.update', $resource->id) }}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <v-card class="elevation-1">
                        <v-toolbar flat class="transparent">
                            <v-icon>label</v-icon>
                            <v-toolbar-title class="subheading">{{ __("Edit Forum Category") }}</v-toolbar-title>
                            <v-spacer></v-spacer>
                        </v-toolbar>
                        <v-card-text>
                            <v-text-field
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn flat href="{{ route('forums.categories.index') }}">{{ __('Cancel') }}</v-btn>
