...
Route::get('comments/all', '\Comment\Controllers\API\CommentController@index')->name('comments.all');
Route::delete('comments/destroy', '\Comment\Controllers\API\CommentController@destroy')->name('comments.destroy');
