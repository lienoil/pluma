<template>
  <svg
    ...
    <circle opacity="0.8" :fill="iconColor" cx="256" cy="256" r="256"/>
    <path :fill="iconColor" d="M503.9,320.14L432,140c0-4.4-3.6-8-8-8h-4v-1.852c-1.296-0.26-2.628-0.536-4-0.828v-1.224v-2.048V124
