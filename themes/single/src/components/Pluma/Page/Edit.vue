        ...
        <v-layout row wrap>
          <v-flex xs12 sm8 md9>
            ...
            <v-card>
                  ...
                  <v-slide-y-transition>
                    <v-card flat v-show="lesson.model">
                      ...
                      <v-card flat>
                        ...
                        <v-toolbar card dense class="transparent">
                          <v-icon class="draggable-handle" color="light-blue">extension</v-icon>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn ripple dark ref="add-lesson-button" color="green" @click="resource.lessons.push({name: 'Lesson', model: true, contents: [], contentmodel: true})"><v-icon left>add</v-icon> Add Lesson</v-btn>
              </v-card-actions>
            </v-card>
...
export default {
  name: 'Edit',
  components: { AlertIcon, Editor, Mediabox },
  data () {
    return {
      resource: {
        saving: false,
