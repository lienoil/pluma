                ...
                <form action="<?php echo e(route('installation.write')); ?>" class="form" method="POST">
                    ...
                    <div class="form-block p-b-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="APP_NAME" class="form-control" value="<?php echo e(env('APP_NAME')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="APP_TAGLINE" class="form-control" value="<?php echo e(env('APP_TAGLINE')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="APP_YEAR" class="form-control" value="<?php echo e(date('Y')); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-block p-b-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="DB_DATABASE" class="form-control" value="<?php echo e(env('DB_DATABASE')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="DB_USERNAME" class="form-control" value="<?php echo e(env('DB_USERNAME')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="password" name="DB_PASSWORD" class="form-control" value="<?php echo e(env('DB_PASSWORD')); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-block p-b-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="MAIL_DRIVER" class="form-control" value="<?php echo e(env('MAIL_DRIVER')); ?>">
                            </div>
                        </div>
