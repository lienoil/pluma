...
<head>
    ...
    <title>
        ...
        <?php $__env->startSection("head.subtitle"); ?><?php echo e($application->head->separator); ?> <?php echo e(isset($application) && isset($application->head->tagline) ? $application->head->tagline : ''); ?><?php echo $__env->yieldSection(); ?>
    </title>
