...
@section('head:title', __('Roles - Users'))
...
@section('page:content')
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        @foreach ($repository->permissions() as $batch => $permissions)
          <div class="treeview" data-treeview="{{ json_encode($permissions) }}"></div>
        @endforeach
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-3">
        <form class="card mb-3" action="{{ route('roles.store') }}" method="POST">
          {{ csrf_field() }}
          <div class="card-header border-0">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              @include('Theme::errors.span', ['field' => 'name'])
            </div>
            <div class="form-group">
              <label class="form-label">{{ __('Description') }}</label>
              <textarea type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}">{{ old('description') }}</textarea>
              @include('Theme::errors.span', ['field' => 'description'])
            </div>
          </div>
