                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" bgcolor="#66b9e5" style="padding: 40px 0 30px 0; border-radius: 3px;">
                                        <img src="{{ $message->embed(assets('frontier/images/icons/clock.png')) }}" alt="{{ $application->site->title }}" width="120" style="display: block;" />
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <tr>
                                            @if (settings('social_links.facebook', false))
                                                <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                                                    <a href="{{ settings('social_links.facebook', false) }}">
                                                        <img src="facebook.png" width="37" height="37" alt="Facebook" border="0" />
                                                    </a>
                                                </td>
                                            @endif
                                            ...
                                            <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                                                <a href="{{ settings('social_links.linkedin', false) }}">
                                                    <img src="linkedin.png" width="37" height="37" alt="Twitter" border="0" />
                                                </a>
                                            </td>
                                            @endif
                                        </tr>
