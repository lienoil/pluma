@viewable(widgets('cpu-usage'))
    ...
    >
        <v-card class="elevation-1 mb-3 draggable-widget">
            <v-card-media height="150px" src="{{ assets('frontier/images/placeholder/s1.png') }}">
                ...
                <v-toolbar card class="sortable-handle transparent white--text">
                    ...
                    <v-toolbar-title class="headline"><strong>{{ __(widgets('cpu-usage')->name) }}</strong></v-toolbar-title>
                </v-toolbar>
            </v-card-media>
            <v-card-text class="pa-4 grey--text text--lighten-1 text-xs-center">
                <div>
                </div>
