            ...
            <v-flex sm8 md6 offset-sm2 offset-md3>
                <v-card class="mt-4 mb-3 elevation-1 grey--text">
                    ...
                    <v-card-text>
                        ...
                        <p>{{ __("If you're ready, then we're ready.") }}</p>
                    </v-card-text>

                    <v-card-actions>
                        <v-btn primary href="{{ route('installation.next') }}">{{ __('Start') }}</v-btn>
                    </v-card-actions>
                ...
                <div class="text-xs-center">
                    ...
                    <br>
                    <small class="grey--text">{!! __("If you think there is a mistake, and you've already installed the app, then check if the .install file is on the root of the folder. If it exists, simply delete it.") !!} </small>
